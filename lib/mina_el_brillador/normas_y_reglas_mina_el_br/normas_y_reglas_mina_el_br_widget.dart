...
import 'normas_y_reglas_mina_el_br_model.dart';
export 'normas_y_reglas_mina_el_br_model.dart';

class NormasYReglasMinaElBrWidget extends StatefulWidget {
  const NormasYReglasMinaElBrWidget({super.key});

  @override
  State<NormasYReglasMinaElBrWidget> createState() =>
      _NormasYReglasMinaElBrWidgetState();
}

class _NormasYReglasMinaElBrWidgetState
    extends State<NormasYReglasMinaElBrWidget> {
  late NormasYReglasMinaElBrModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NormasYReglasMinaElBrModel());
