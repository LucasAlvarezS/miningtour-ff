...
import 'normas_y_reglas_mina_de_cuarzo_model.dart';
export 'normas_y_reglas_mina_de_cuarzo_model.dart';

class NormasYReglasMinaDeCuarzoWidget extends StatefulWidget {
  const NormasYReglasMinaDeCuarzoWidget({super.key});

  @override
  State<NormasYReglasMinaDeCuarzoWidget> createState() =>
      _NormasYReglasMinaDeCuarzoWidgetState();
}

class _NormasYReglasMinaDeCuarzoWidgetState
    extends State<NormasYReglasMinaDeCuarzoWidget> {
  late NormasYReglasMinaDeCuarzoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NormasYReglasMinaDeCuarzoModel());
